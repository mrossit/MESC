...
const VERSION = '5.4.7'; // Injected from package.json
const BUILD_TIME = '2026-07-05T23:15:59.555Z'; // Injected at build time
const BUILD_TIMESTAMP = 1783293359555; // Injected at build time (used for cache busting)
