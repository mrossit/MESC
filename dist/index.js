    ...
    try {
      ...
      if (apiData.celebracao) {
        ...
        if (celebracao.includes("solenidade")) {
          ...
          liturgyRank = "FEAST";
        } else if (celebracao.includes("mem\xF3ria obrigat\xF3ria")) {
          liturgyRank = "MEMORIAL";
        } else if (celebracao.includes("mem\xF3ria")) {
...
${meditation}`);
  ...
  return "Liturgia do dia. Para mais informa\xE7\xF5es, visite: https://liturgia.cnbb.org.br/";
}
