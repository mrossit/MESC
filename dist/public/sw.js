...
const VERSION = '5.4.3'; // Injected from package.json
const BUILD_TIME = '2026-02-28T23:31:45.924Z'; // Injected at build time
const BUILD_TIMESTAMP = 1772321505924; // Injected at build time (used for cache busting)
