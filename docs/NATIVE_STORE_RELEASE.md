...
- TestFlight: build `5.4.3 (50430)` enviado ao App Store Connect para substituir o `50429` nos testes internos contra `https://saojudastadeu.app`; processamento `VALID` e build visivel no grupo interno `MESC Interno`.
...
O app iOS ja possui Push Notifications habilitado no Bundle ID `app.saojudastadeu.mesc` e o IPA `5.4.3 (50430)` foi assinado com `aps-environment=production`.
