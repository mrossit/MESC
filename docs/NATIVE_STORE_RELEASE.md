...
- TestFlight: build `5.4.3 (50418)` em estado `VALID`, associado ao grupo interno `MESC Interno`; nao distribuir como teste fiel antes da correcao DNS de `saojudastadeu.app`, pois o app nativo usa esse host como API.
