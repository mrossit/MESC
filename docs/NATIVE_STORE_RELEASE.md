...
- TestFlight: build `5.4.7 (50444)` enviado ao App Store Connect para processamento contra `https://saojudastadeu.app`; apos ficar `VALID`, associar ao grupo interno `MESC Interno`.
