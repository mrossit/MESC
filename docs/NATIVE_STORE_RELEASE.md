...
- TestFlight: build `5.4.3 (50419)` em estado `VALID`, associado ao grupo interno `MESC Interno` e pronto para teste fiel contra `https://saojudastadeu.app`.
