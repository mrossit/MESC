...
- Version: `5.4.3`
- Native build number / Android version code: `50417`
...
- TestFlight: build `5.4.3 (50417)` em estado `VALID`, `APP_STORE_ELIGIBLE`, associado ao grupo interno `MESC Interno`; este e o candidato para corrigir cache/domínio antigo no aparelho.
