...
- TestFlight: build `5.4.3 (50435)` enviado ao App Store Connect para substituir o `50434` nos testes internos contra `https://saojudastadeu.app`; processamento `VALID` e build visivel no grupo interno `MESC Interno`.
...
O app iOS ja possui Push Notifications habilitado no Bundle ID `app.saojudastadeu.mesc` e o IPA `5.4.3 (50435)` foi assinado com `aps-environment=production`.
