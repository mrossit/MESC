...
- Version: `5.4.3`
- Native build number / Android version code: `50416`
...
- TestFlight: build `5.4.3 (50416)` em estado `VALID`, `APP_STORE_ELIGIBLE`, disponivel para testers internos assim que o App Store Connect propagar a interface; build `50415` permanece como candidato MVP P0 anterior.
