...
- Capacitor configurado para empacotamento nativo inicial (`app.saojudastadeu.mesc`) com pastas `ios/` e `android/` geradas.
- Versao nativa alinhada com o app web: `5.4.3` / build `50403`.
...
8. Abrir Xcode/Android Studio, configurar assinatura oficial e validar builds em dispositivo real antes da submissao oficial.
