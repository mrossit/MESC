...
async function fixJulia() {
  const email = 'juuliafvaz@gmail.com';
  const weekdays = {
    monday: false,
    tuesday: false,
    wednesday: true,  // Quarta-feira
    thursday: false,
    friday: false
  };
  const dailyMassAvailability = ['Quarta-feira'];
  ...
  try {
    ...
    console.log(`   → Disponível: Quarta-feira`);
    console.log('\n✅ Correção concluída!');
